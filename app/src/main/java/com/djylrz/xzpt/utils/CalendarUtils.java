...
public class CalendarUtils {
    ...
    private static String CALENDARS_NAME = "supermingjun";
    private static String CALENDARS_ACCOUNT_NAME = "supermingjun@supermingjun.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.supermingjun";
    private static String CALENDARS_DISPLAY_NAME = "待就业六人组-校招平台";
    private static volatile CalendarUtils instance = null;
