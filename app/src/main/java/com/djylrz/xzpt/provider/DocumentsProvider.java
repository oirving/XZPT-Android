package com.djylrz.xzpt.provider;
...
public class DocumentsProvider extends ContentProvider {
    ...
    public String getType(@NonNull Uri uri) {
        if (DocumentsContract.isDocumentUri(MyApplication.getAppContext(), uri)) {
            if (isExternalStorageDocument(uri)) {// ExternalStorageProvider
                ...
                return getDataColumn(MyApplication.getAppContext(), contentUri, selection, selectionArgs);
            }
            ...
            return getDataColumn(MyApplication.getAppContext(), uri, null, null);
