...
public class RecruitmentAdapter extends RecyclerView.Adapter<RecruitmentAdapter.ViewHolder> {
    ...
    public RecruitmentAdapter(List<Recruitment> recruitmentList) {
        mRecruitments = recruitmentList;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        holder.recruitmentView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(v.getContext(), "you clicked view " + recruitment.getCompanyId(), Toast.LENGTH_SHORT).show();
            }
        });
